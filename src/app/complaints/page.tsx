      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        {loading ? (
          ...
          <motion.div
            ...
            className="border border-dashed border-zinc-200 rounded-lg p-12 flex flex-col items-center justify-center text-center"
          >
          ...
          <div className="space-y-3">
            {complaints.map((c, i) => (
              <motion.div
                ...
                role="button"
                tabIndex={0}
                className="group cursor-pointer border border-zinc-200 rounded-lg bg-white hover:border-zinc-400 hover:shadow-md transition-all p-5 flex items-start gap-4 focus:outline-none focus:ring-2 focus:ring-zinc-900"
              >
                {/* Icon */}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    <span className={`text-[10px] font-mono font-bold uppercase tracking-wider px-2 py-0.5 rounded-md border ${URGENCY_COLORS[c.urgencyLevel] || URGENCY_COLORS.MEDIUM}`}>
                      {c.urgencyLevel}
                    </span>
                    <span className="text-[10px] font-mono font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md border bg-zinc-50 text-zinc-600 border-zinc-200">
