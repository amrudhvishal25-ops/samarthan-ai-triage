    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-lg bg-white rounded-2xl border border-zinc-200 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
        >
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200 bg-[#FAFAF8]">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-[#1A3A6B] text-white flex items-center justify-center">
          ...
          <div className="p-6 overflow-y-auto space-y-6">
              ...
              <div className="text-center py-4 space-y-4">
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                  <button
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#1A3A6B] hover:bg-[#152d54] text-white rounded-xl px-6 py-3 text-sm font-semibold transition-all shadow-sm disabled:opacity-50"
                  >
                    {isActionLoading ? (
                ...
                <div className="mt-4 pt-4 border-t border-zinc-100 text-left">
                  ...
                  <div
                    ...
                    className="cursor-pointer group flex items-center justify-between bg-zinc-900 text-zinc-200 text-xs font-mono px-3.5 py-2.5 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors"
                  >
            ...
            {state.isRunning && state.status === 'SCAN_QR' && state.qrDataUrl && (
              <div className="space-y-5">
                ...
                {/* Steps */}
                <div className="space-y-2.5 bg-blue-50/60 p-4 rounded-xl border border-blue-100 text-xs text-zinc-700">
                ...
                <div className="flex items-center justify-between pt-1">
                  <button
                    ...
                    disabled={isActionLoading}
                    className="inline-flex items-center gap-1.5 text-xs text-zinc-600 hover:text-zinc-900 font-medium py-1 px-2.5 rounded-lg border border-zinc-200 hover:bg-zinc-100 transition-colors"
                  >
                  ...
                  <button
                    ...
                    disabled={isActionLoading}
                    className="inline-flex items-center gap-1.5 text-xs text-red-600 hover:text-red-700 font-medium py-1 px-2.5 rounded-lg border border-red-200 hover:bg-red-50 transition-colors"
                  >
            ...
            {state.isRunning && state.status === 'CONNECTED' && (
              <div className="text-center py-4 space-y-5">
                ...
                {/* Capabilities Banner */}
                <div className="bg-[#FAFAF8] border border-zinc-200 rounded-xl p-4 text-left text-xs space-y-2">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                  ...
                  <button
                    ...
                    onClick={() => handleAction('restart')}
                    disabled={isActionLoading}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 text-zinc-700 hover:text-zinc-900 bg-white border border-zinc-200 hover:bg-zinc-50 rounded-xl px-4 py-2.5 text-sm font-medium transition-colors"
                  >
