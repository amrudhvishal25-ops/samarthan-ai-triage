    ...
    <>
      ...
      <section className="bg-[#0A0A0A] text-white">
        <div className="max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          <button
            onClick={startReport}
            className="mt-8 inline-flex items-center gap-2 bg-[#1A3A6B] hover:bg-[#152d54] text-white rounded-full px-8 py-3.5 text-sm font-semibold transition-colors shadow-sm"
          >
