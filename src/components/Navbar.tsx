      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-md">
        ...
        <header className="border-b border-zinc-200/80 transition-all">
          <div className="max-w-6xl mx-auto px-3 sm:px-6 h-[58px] sm:h-[72px] flex items-center justify-between">
            ...
            {/* Logo */}
            <button onClick={() => router.push('/')} className="flex items-center gap-2 sm:gap-3 group text-left">
              ...
              {user ? (
                <div className="relative">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-medium text-zinc-900 bg-zinc-100 hover:bg-zinc-200/80 border border-border rounded-md px-2.5 sm:px-4 py-2 sm:py-2.5 h-9 sm:h-10 transition-colors cursor-pointer"
                  >
                  ...
                  {userMenuOpen && (
                    <div className="absolute right-0 top-full mt-1.5 w-56 bg-white border border-border rounded-lg shadow-lg overflow-hidden z-50">
