  ...
  return (
    <div className="bg-white rounded-lg border border-zinc-200 p-6 shadow-sm">
      ...
      <div className="flex flex-col gap-2 mb-4">
        ...
        <div className="flex gap-2">
          <textarea
            ...
            className="flex-1 bg-zinc-50 border border-zinc-200 rounded-md p-3 text-sm text-zinc-900 placeholder-zinc-400 resize-none outline-none focus:ring-2 focus:ring-zinc-900 focus:border-transparent transition-all"
          />
        <button
      ...
      {allActionPoints.length > 0 && (
        <div className="mb-4 border border-amber-200 bg-amber-50 rounded-lg p-3.5">
