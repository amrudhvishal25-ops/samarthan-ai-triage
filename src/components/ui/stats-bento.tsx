  ...
  return (
    <section className="bg-background flex flex-col justify-center py-12">
      <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-2 gap-4 max-w-6xl mx-auto px-6 w-full">
        {/* Primary Stat */}
        <div className="md:col-span-3 md:row-span-2 bg-[#1A3A6B] rounded-none p-10 flex flex-col justify-between overflow-hidden relative shadow-sm">
          ...
          <div>
            <span className="inline-block px-3 py-1 bg-white/10 rounded-none text-[10px] font-mono font-semibold text-white/80 uppercase tracking-widest mb-6">
              1930 NCRP Framework
            </span>
        ...
        {/* Secondary Stat A */}
        <div className="md:col-span-3 bg-white rounded-none p-8 border border-zinc-200 flex items-center justify-between shadow-xs">
          <div>
        ...
        {/* Tertiary Stat C */}
        <div className="md:col-span-2 bg-zinc-50 rounded-none p-6 border border-zinc-200 flex items-center gap-4 shadow-xs">
          <div className="size-11 text-lg rounded-none bg-[#1A3A6B] text-white flex items-center justify-center shrink-0 font-bold">
            🛡️
          </div>
          <div>
